export const Footer = () => (
  <footer class="bg-gray-50 text-gray-700">
    <div
      id="footer-content"
      class="relative pt-16 pb-6 xl:pb-12 text-center lg:text-left"
    >
        ...
        <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
          ...
          <div class="flex-shrink max-w-full w-full lg:w-1/2 px-3">
            <div class="flex flex-wrap flex-row">
              <div class="flex-shrink max-w-full w-full sm:w-1/2 mb-6 lg:mb-0">
              ...
              <div
                id="contact"
                class="flex-shrink max-w-full w-full sm:w-1/2 mb-6 lg:mb-0"
              >
                <h4 class="text-base leading-normal mb-3 uppercase text-gray-800 font-semibold">
                  Contact
                </h4>
